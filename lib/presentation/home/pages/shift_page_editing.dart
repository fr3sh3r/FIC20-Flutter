                                                    ...
                                                    IconButton(
                                                      onPressed: () =>
                                                        ...
                                                        builder: (context) =>
                                                            EditShift(
                                                          shift:
                                                              item, // Pass the shift to edit
                                                          shiftId: item
                                                              .id!, // Add this line to pass shiftId
                                                          companyId: item
                                                              .companyId!, // Add this line to pass companyId
                                                          createdBy: item
                                                              .createdBy!, // Add this line to pass createdBy
                                                          initialName: item
                                                              .name!, // Add this line to pass initialName
                                                          initialClockInTime:
                                                              parseTime(item
                                                                  .clockInTime!), // Convert String to TimeOfDay
                                                          initialClockOutTime:
                                                              parseTime(item
                                                                  .clockOutTime!), // Convert String to TimeOfDayAdd this line to pass initialClockOutTime
                                                          initialIsSelfClocking:
                                                              item.isSelfClocking!, // Add this line to pass initialIsSelfClocking
                                                        ),
                                                      ).then((updatedShift) {
                                                        if (updatedShift !=
                                                            null) {
                                                          // Call the Bloc to update the shift with the new values
                                                          context
                                                              .read<
                                                                  UpdateShiftBloc>()
                                                              .add(
                                                          ...
                                                          // Once the update is done, trigger the GetShiftBloc to refresh the data
                                                          context
                                                              .read<
                                                                  GetShiftBloc>()
                                                              .add(const GetShiftEvent
